...
#define make_interface_func( name, type, offset_name, module_name ) inline auto name = []() __attribute__((always_inline)) { return encrypted_ptr<type>(reinterpret_cast< uintptr_t( * )( ) >( make_offset( module_name, offset_name ) )( ) ); };
